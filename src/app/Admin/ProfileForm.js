    ...
    <div className="col-md-12 grid-margin stretch-card">
      ...
      {/* <div className="card-header"><h4>Sourcing Events</h4></div> */}
        <div className="card-body">
          <h4 className="card-title text-muted">My Profile</h4><hr className="mt-1" />
          <br/>
          ...
          <ol className="number-circle-list">
                  ...
                  <Form.Group className="col-6 col-md-6 col-sm-12">
                    <label htmlFor="exampleSelectGender"><strong>Timezone</strong></label>
                    <select className="form-control form-control-sm" id="currency" name="currency">
                    <option value="">-- Select Option --</option>
                      <option value="Accra/ Africa/ UTC +00">Accra/ Africa/ UTC +00</option>
                      <option value="Accra/ Africa/ UTC +00">Accra/ Africa/ UTC +00</option>
                    </select>
                  </Form.Group>
                  <Form.Group className="col-6 col-md-6 col-sm-12">
                    <label htmlFor="exampleSelectGender"><strong>Language</strong></label>
                    <select className="form-control form-control-sm" id="currency" name="currency">
                    <option value="">-- Select Option --</option>
                  ...
                  <li className="number-circle-list--list-item"> 
                    <span className="card-text text-black">Login</span>
                    <br />
                    <br />
                  <div className="ml-4">  
                  ...
                  <Form.Group className="col-6 col-md-6 col-sm-12">
                    <label htmlFor="exampleInputName1"><strong>Password</strong></label>
                    <Form.Control type="password" className="form-control form-control-sm" id="title" name="title"  />
                  </Form.Group>
                  </div>
                  </li>
            </ol> 
