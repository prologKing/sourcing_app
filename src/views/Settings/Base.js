              ...
              <div className="small text-medium-emphasis">
                <ul className="nav nav-tabs" id="myTab" role="tablist">
                  <li className="nav-item">
                    <a className={isActive == 1 ? "nav-link active" : "nav-link"} onClick={() => setActiveKey(1)} id="users-tab" data-coreui-toggle="tab" role="tab" aria-controls="users" aria-selected="true">Users</a>
                  </li>
                  <li className="nav-item">
                    <a className={isActive == 2 ? "nav-link active" : "nav-link"} onClick={() => setActiveKey(2)} id="security-tab" data-coreui-toggle="tab" role="tab" aria-controls="security" aria-selected="false">Security</a>
                  </li>
                  <li className="nav-item">
                    <a className={isActive == 3 ? "nav-link active" : "nav-link"} onClick={() => setActiveKey(3)} id="account-tab" data-coreui-toggle="tab" role="tab" aria-controls="account" aria-selected="false">Account</a>
                  </li>
                  <li className="nav-item">
                    <a className={isActive == 4 ? "nav-link active" : "nav-link"} onClick={() => setActiveKey(4)} id="license-tab" data-coreui-toggle="tab" role="tab" aria-controls="license" aria-selected="false">License</a>
                  </li>
                  <li className="nav-item">
                    <a className={isActive == 5 ? "nav-link active" : "nav-link"} onClick={() => setActiveKey(5)} id="suppliers-tab" data-coreui-toggle="tab" role="tab" aria-controls="suppliers" aria-selected="false">Suppliers</a>
                  </li>
                </ul>
