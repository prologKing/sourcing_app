  ...
  render () {
    return (
      <nav className="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div className="text-center navbar-brand-wrapper d-flex align-items-center p-4">
          <Link className="brand-logo" to="/"><img src={require('../../assets/images/logo1.png')} width="180px" height="54px" alt="logo" /></Link>
          <Link className="navbar-brand brand-logo-mini" to="/"><img src={require('../../assets/images/logomini.png')} alt="logo" /></Link>
        </div>
...
<li className="nav-item">
            ...
            <li className="nav-item nav-profile nav-language" style={{borderLeft: '2px solid #E6E6E6'}}>
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link count-indicator">
                  <div className="nav-profile-img">
                    ...
                    <div className="nav-profile-text">
                      <p className="mb-1 text-black">Felix Nkansah</p>
                      <small className="float-left text-muted">Joy Inc.</small>
                  </div>
                </Dropdown.Toggle>
                <Dropdown.Menu className="preview-list navbar-dropdown">
                  <div className="p-3 text-center bg-primary">
                    <img  src={require("../../assets/images/faces/face28.png")} alt=""/>
                  </div>
                  <div className="p-2">
