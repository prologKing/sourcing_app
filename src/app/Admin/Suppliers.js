...
function Suppliers(props) {
  ...
  const showDetails = () => {
    window.location.assign("/admin/supplier/details");
  };
          ...
          <div className="col-md-12 grid-margin stretch-card">
            ...
            {/* <div className="card-header"><h4>Sourcing Events</h4></div> */}
              <div className="card-body">
                <h4 className="card-title text-muted">Suppliers <a href="/admin/supplierform" style={{backgroundColor:'#629C44'}} size="sm" className="btn btn-success float-right">New</a></h4><hr />
                ...
                <div className="media">
                  ...
                  <div className="media-body">
                    ...
                    <Dropdown.Menu>
                      ...
                      <Dropdown.Item onClick={showDetails}>View <FontAwesomeIcon icon={faEye} size="lg" /></Dropdown.Item>
